        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                do
                {
                    ...
                    Console.WriteLine("Вы оказались в небольшой деревушке на окраине болот и видите перед собой несколько скошенных домов." +
                        "\nВдоль одной кривой улицы - по видимому главной - расположены Таверна и магазинчики. " +
